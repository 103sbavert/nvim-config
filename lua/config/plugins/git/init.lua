...
return {
    ...
    opts = {
        ...
        on_attach = function(bufnr)
            ...
            -- Initialize mappers
            local git_key_mapper =
                create_keymap_group("[g]it", "<leader>g", { "n", "v" })
            local git_reset_mapper =
                create_keymap_group("[r]eset", "<leader>gr", { "n", "v" })
            local navigate_bw_mapper =
                create_keymap_group("[ backwards", "[", { "n", "v" })
            local navigate_fw_mapper =
                create_keymap_group("] forwards", "]", { "n", "v" })
